...
//        final ImageView imv_pic3 = (ImageView) findViewById(R.id.imv_pic3);
    ...
    public void addMarker(LatLng ll, String str) {
        if(ll==null) return;
        mMap.addMarker(new MarkerOptions().position(ll).title(str));
    }
    ...
    public boolean onHomeOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.main_opt_menu_item_startActivity2) {
            Intent intent = new Intent(RunningActivity.this, StartRunActivity.class);
            startActivity(intent);
            return true;
        }
